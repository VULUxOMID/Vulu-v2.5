...
type ContactsPermissionScreenNavigationProp = StackNavigationProp<OnboardingStackParamList, 'ContactsPermission'>;

const ContactsPermissionScreen: React.FC = () => {
  const navigation = useNavigation<ContactsPermissionScreenNavigationProp>();
  ...
  return (
    <View style={styles.container}>
      ...
      <OnboardingCenteredCard
        title={<Text style={styles.title}>ContactsPermission Title</Text>}
        subtitle={<Text style={styles.subtitle}>Placeholder for ContactsPermissionScreen</Text>}
      />
      <OnboardingFooter
