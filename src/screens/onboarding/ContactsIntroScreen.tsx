...
type ContactsIntroScreenNavigationProp = StackNavigationProp<OnboardingStackParamList, 'ContactsIntro'>;

const ContactsIntroScreen: React.FC = () => {
  const navigation = useNavigation<ContactsIntroScreenNavigationProp>();
  ...
  return (
    <View style={styles.container}>
      ...
      <OnboardingCenteredCard
        title={<Text style={styles.title}>ContactsIntro Title</Text>}
        subtitle={<Text style={styles.subtitle}>Placeholder for ContactsIntroScreen</Text>}
      />
      <OnboardingFooter
...
export default ContactsIntroScreen;
